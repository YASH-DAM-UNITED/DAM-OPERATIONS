...
import MoomaStockRecord from "./MoomaStockRecord";
import MoomaStockTransfer from "./MoomaStockTransfer";
import MoomaStockView from "./MoomaStockView";
...
export default function MoomaDashboard({
    ...
    useCallback(
      async ({
        ...
        try {
          ...
          const response =
            await fetch(
              `/api/mooma/pending-transfers?branch=${encodeURIComponent(
                branch.code
              )}`,
              {
                cache: "no-store",
  ...
  async function loadStockView(
    ...
    try {
      ...
      const url =
        `/api/mooma/stock-view?branch=${encodeURIComponent(
          branch.code
        )}${
          forceRefresh
            ? "&refresh=1"
  ...
  async function openModule(
    ...
    if (
      ...
      setOpeningModule(modules.find((item) => item.id === "stock-view"));
      smoothTop();
      window.setTimeout(() => {
        setActive("stock-view-full");
  ...
  return (
    <div className="mooma-dashboard">

      <div className="mooma-dashboard-grid" />

      <div className="mooma-dashboard-glow glow-one" />

      <div className="mooma-dashboard-glow glow-two" />
      ...
      <header className="mooma-dashboard-nav">

        <motion.div
          className="mooma-dash-brand"
          initial={{
            opacity: 0,
            x: -15,
          }}
        ...
        >
          <div className="mooma-session-status">
            <span />
          ...
          <button
            type="button"
            className="mooma-icon-button danger"
            onClick={() => {
              touchSession();
      ...
      <main className="mooma-dashboard-main">
        ...
        <section className="mooma-dashboard-hero">
          ...
          >
            <div className="mooma-mini-label">
              <Activity
                size={12}
              />
          ...
          >
            <div className="mooma-branch-top">
              <div className="mooma-branch-location">
                <MapPin
                  size={16}
                />
              </div>
            ...
            <div className="mooma-branch-code">
              {branch?.code ||
                "B000"}
            </div>

            <div className="mooma-branch-meta">
              <div>
                <Clock3
                  size={14}
                />
        ...
        >
          <div className="mooma-notification-icon">
            <Bell
              size={17}
            />
          </div>

          <div className="mooma-notification-text">
            <small>
              LIVE TRANSFER CENTER
            </small>
        ...
        <AnimatePresence>
          {transferMessage && (
            <motion.div
              className={
                `mooma-operation-message ${transferMessage.type}`
              }
              initial={{
                opacity: 0,
                y: -8,
        ...
        <motion.section
          className="mooma-database-status-card"
          initial={{
            opacity: 0,
            y: 15,
          }}
        ...
        >
          <div className="mooma-db-status-left">
            <div className="mooma-db-icon">
              <Database
                size={17}
              />
            </div>
        ...
        <AnimatePresence>
          {databaseMessage && (
            <motion.div
              className={
                `mooma-operation-message ${databaseMessage.type}`
              }
              initial={{
                opacity: 0,
                y: -8,
        ...
        <section className="mooma-module-header">
          <div>
            <span>
              OPERATIONS
            </span>
          ...
          <div className="mooma-module-count">
            04 MODULES
          </div>
        </section>
        ...
        <section className="mooma-module-grid">
          {modules.map(
            (
              module,
              index
              ...
              return (
                ...
                >
                  <div className="mooma-card-light" />

                  <div className="mooma-module-top">
                    <div className="mooma-module-icon">
                      <Icon
                        size={22}
                      />
                    </div>

                    <span className="mooma-module-number">
                      {module.number}
                    </span>
                  </div>

                  <div className="mooma-module-subtitle">
                    {module.subtitle}
                  </div>
                  ...
                  <div className="mooma-module-open">
                    <span>
                      {active
                        ? "CLOSE VIEW"
                        : "OPEN MODULE"}
        ...
        >
          ...
          <div className="mooma-status-line" />
