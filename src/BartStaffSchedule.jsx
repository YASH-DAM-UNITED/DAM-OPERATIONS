...
export default function BartStaffSchedule({
  branch,
  onBack,
}) {
  ...
  async function loadSchedule(force = false) {
    ...
    try {
      ...
      const response = await fetch(
        `/api/staff/bart/schedule/init?branch=${encodeURIComponent(
          branch.code
